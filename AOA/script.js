/**
 * ================================================================
 *   Analysis of Algorithm (AOA) Lab - Interactive Logic
 * ================================================================
 *   Author: Amey Thakur
...
if (shareBtn) {
    shareBtn.addEventListener('click', async () => {
        const shareData = {
            title: 'Analysis of Algorithm Lab Portfolio — Amey Thakur',
            text: 'Analysis of Algorithm Lab Portfolio — Amey Thakur',
...
function initApp() {
    ...
    // =========================================
    //   COMMAND PALETTE LOGIC (Initialized Separately)
    // =========================================
    // initCommandPalette is defined and called at the end of this file
}
// 5. Low-Level Security Measures (Standardized)
// Disable Right Click
document.addEventListener('contextmenu', (e) => {
